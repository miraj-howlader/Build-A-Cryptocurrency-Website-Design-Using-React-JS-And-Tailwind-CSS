  ...
  return <section className=' py-[30px] lg:py-[120px]'>
    <div className="container mx-auto">
      <div className=' flex flex-col justify-end items-center lg:flex-row'>
        ...
        data-aos='fade-right'
        data-aos-offset='400'
         className=' flex-1 lg:absolute lg:left-0
         order-2 lg:order-1'>
          <img src={Image2} alt="" />
        </div>
        {/* text  */}
        ...
        data-aos-offset='400'
         className=' flex-1 max-w-[456px]'>
          <h3  className=' h3 mb6'>Detailed Statistics</h3>
          <p className=' text-gray mb-8'>View all minig related information in realtime, at any
            point at any location and decide which polls to mine in.
          </p>
